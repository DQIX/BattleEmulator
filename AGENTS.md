...
* PLEASE DO NOT RESTORE the differences that I deleted for my own convenience.
  ...
  * This does not disable any learning that would otherwise prevent computer storage damage.
...
cmake --build cmake-build-release2 --target newDirectory_gouketu --config Release
