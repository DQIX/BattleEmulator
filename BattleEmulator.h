...
public:
    ...
    static constexpr int CRACKLE_ENEMY = 180; //ヒャダルコ
    static constexpr int MAGIC_BARRIER = 181; //マジックバリア
...
private:
    ...
    static void ProcessRage(int *position, int baseDamage, Player *players);
