...
double CostParams::CRACKLEPenalty = 0.001;
double CostParams::antidotePenalty = 0.001;
double CostParams::wooshAllyPenalty = 0.1;
...
std::string CostParams::toText() {
    ...
    oss << "enemyHpWeight=" << enemyHpWeight << "\n"
        ...
        << "CRACKLEPenalty=" << CRACKLEPenalty << "\n"
        << "wooshAllyPenalty=" << wooshAllyPenalty << "\n"
        << "antidotePenalty=" << antidotePenalty << "\n"
...
void CostParams::setDefaults() {
    ...
    CRACKLEPenalty = 0.001;
    wooshAllyPenalty = 0.001;
    antidotePenalty = 0.1;
    paralysisWeight = 1.0;
    sleepWeight = 1.5;
    poisonWeight = 0.5;
...
void CostParams::copyFrom(const CostParams& other) {
    ...
    CRACKLEPenalty = other.CRACKLEPenalty;
    wooshAllyPenalty = other.wooshAllyPenalty;
    antidotePenalty = other.antidotePenalty;
...
CostParams SimpleParameterOptimizer::generateRandom() {
    ...
    std::uniform_real_distribution<> CRACKLEPenalty(0.01, 2.0);
    std::uniform_real_distribution<> antidotePenalty(0.01, 2.0);
    std::uniform_real_distribution<> wooshAllyPenalty(0.01, 2.0);
    ...
    params.CRACKLEPenalty = CRACKLEPenalty(gen);
    params.wooshAllyPenalty = wooshAllyPenalty(gen);
    params.antidotePenalty = antidotePenalty(gen);
